...
public class Events {
	...
	public Events(int eventId, @NotNull(message = "Name must be mentioned") String eventName, String eventGenre,
			@Range(min = 1, max = 3) int eventHours, String eventLanguage, LocalDate eventDate, LocalTime eventTime,
	...
	@Override
	public int hashCode() {
		return Objects.hash(eventDate, eventGenre, eventHours, eventId, eventLanguage, eventName, eventTime, theaters);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(eventDate, other.eventDate) && Objects.equals(eventGenre, other.eventGenre)
				&& eventHours == other.eventHours && eventId == other.eventId
				&& Objects.equals(eventLanguage, other.eventLanguage) && Objects.equals(eventName, other.eventName)
				&& Objects.equals(eventTime, other.eventTime) && Objects.equals(theaters, other.theaters);
	}
	...
	public String toString() {
		return "Events [eventId=" + eventId + ", eventName=" + eventName + ", eventGenre=" + eventGenre
				...
				+ ", eventTime=" + eventTime + ", theaters=" + theaters + "]";
	}
