...
public class Movies {
	...
	@Override
	public int hashCode() {
		return Objects.hash(censorRating, movieDescription, movieGenre, movieHours, movieId, movieLanguage, movieName,
				theaters);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(censorRating, other.censorRating)
	...
	public String toString() {
		return "Movies [movieId=" + movieId + ", movieName=" + movieName + ", movieGenre=" + movieGenre
				...
				+ movieDescription + ", censorRating=" + censorRating + ", theaters=" + theaters + "]";
	}
